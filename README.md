...
- 배포 후 에브리타임 및 인스타그램, 지인 등을 통해 사용자 피드백 내용을 신속하게 반영했습니다.
- 웹 사이트 방문자 수를 기록하는 것의 중요성을 인식하지 못해, 관련 시스템을 구축하지 않아 행사가 끝난 후 방문록으로만 사용자 참여도를 확인할 수 있었습니다.
- 이 경험을 바탕으로 추후 프로젝트에서는 Google Analytics와 같은 웹 분석 도구를 적극적으로 활용하여 방문자 수, 페이지 뷰, 사용자의 웹사이트 내 활동 등을 실시간으로 추적하고 분석할 것입니다.
...
- 또한, SVG 이미지 클릭 시 각 홈페이지로 이동하도록 설정하는 과정에서 코드를 분석해 고화질의 벡터 이미지를 적용하는 방법을 배웠습니다.
- 문제 해결 과정에서 다양한 OS와 브라우저에서의 애플리케이션 성능과 표현을 유지하는 것의 중요성을 인식했고, iOS와 Android의 차이점과 이를 해결하기 위한 CSS 속성의 사용법 등 많은 것을 배울 수 있었습니다.
